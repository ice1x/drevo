...
/// Storage & semantic report DTOs now live in [`crate::report`]; re-exported
/// here so existing `crate::db::*` paths keep resolving while the KV engine
/// is retired (epic #444).
pub use crate::report::{
    BloatReport, CompactReport, KeyspaceStat, SemanticReindexReport, SemanticTargetStatus,
};
